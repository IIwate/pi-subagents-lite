...
- List visibility, Footer folding, and `results pending` presentation live in the [child-screen UI state matrix](src/modules/child-screen/docs/ui-states.md).
- Volatile-list retention, pins, and continuation-as-a-new-result live in the [runtime state machine](src/modules/subagent-runtime/docs/state-machine.md). Persist-before-wake and coalesced wake live in [background-result-delivery decisions](src/modules/background-result-delivery/docs/decisions.md).
