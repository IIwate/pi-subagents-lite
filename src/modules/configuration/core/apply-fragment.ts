...
/**
 * Produce the next document with one section's assignments applied.
 * A non-object section on disk is replaced instead of merged: capability
 * normalizers already treat it as absent, so preserving it would keep
 * unreadable data forever.
 */
