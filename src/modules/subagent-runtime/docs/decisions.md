...
- List order is status rank (attention, running, queued, archive) with acceptance order inside a rank; pins do not move rows, and recency-by-startedAt stays retired.
